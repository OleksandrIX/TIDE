...
class LidModelTrainAndTest:
    ...
    def extract_model_from_checkpoint(self, path_to_checkpoint):
        ...
        (epoch, model, optimizer, loss) = self.load_model_from_checkpoint(path_to_checkpoint, 6)
        logger.debug(f"Loaded model from {path_to_checkpoint}")
