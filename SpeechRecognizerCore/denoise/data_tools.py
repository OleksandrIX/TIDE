...
def audio_to_numpy(sample_rate, frame_length, hop_length_frame, path_to_noise_audio):
    y, sr = librosa.load(path_to_noise_audio, sr=sample_rate)
    audio_frames = audio_to_audio_frame_stack(y, frame_length, hop_length_frame)
    return audio_frames
